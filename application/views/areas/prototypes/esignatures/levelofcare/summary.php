            ...
            <div class="form-panelbar-content">
                <fieldset class="fieldset-container-one">
                    ...
                    <div class="header-info">
                        1 - Never or Rarely - even if asked.<br>
                        2 - Does but not well - 1/4 of the time - may need to be asked.<br>
                        3 - Does farely well - or 1/4 of the time - may need to be asked.<br>
                        4 - Does fairly well - or 3/4 of the time - may need to be asked.
                    </div>
                    <div class="row">
                        <fieldset class="grouped-radiobuttons">
                            <legend>Pick up small objects with one hand:</legend>
                            <input type="radio"><label>1</label>
                            <input type="radio"><label>2</label>
                            <input type="radio" title="Does farely well - or 1/4 of the time - may need to be asked."><label>3</label>
