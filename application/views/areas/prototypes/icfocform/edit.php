...
<div class="read-edit-toggle">
    <a href="#" onclick="window.location.href= \''.base_url('/index.php/prototypes/icfocdetails').'\'">View</a>
    <span>Edit</span>
</div>
...
<div class="genericform-style">
    ...
    <fieldset class="fieldset-container-one">
        ...
        <fieldset class="fieldset-container-two">
            ...
            <div class="header-info"><span class="icon-info-sign"></span>By signing below, I hereby acknowledge my participation in selecting the setting I want and that long term services and supports options were explained to me.</div>
            <div class="row">
                <fieldset class="grouped-radiobuttons">
                    <legend class="grouped-radiobuttons-label full-width selection-submit-required">Options Presented to Person:</legend>
                        <div class="row">
                            <input type="checkbox" id="institionalSettingCheck"/>
                            <label for="institionalSettingCheck" class="">Institutional Setting (Nursing Facility)</label>
                        </div>
                        <div class="row">
                            <input type="checkbox" id="homeCommunityBasedCheck"/>
            ...
            <div class="row">
                <fieldset class="grouped-radiobuttons">
                    ...
                    <div class="row">
                        <input type="radio" id="institionalSettingRadio" name="choiceRadio"/>
            ...
            <div id="hcbsSection">
                <fieldset class="fieldset-container-two">
                    ...
                    <div class="header-info"><span class="icon-info-sign"></span>By signing below, I hereby acknowledge my participation in selecting the waiver I want and that long term services and supports options were explained to me.</div>
                <div class="row">
                        <fieldset class="grouped-radiobuttons">
                            ...
                            <div class="row">
                                <input type="checkbox" id="alwaiver-checkbox"/>
                                <label for="alwaiver-checkbox" class="">Assisted Living Waiver</label>
                            </div>
                            <div class="row">
                                <input type="checkbox" id="edwaiver-checkbox"/>
                    ...
                    <div class="row">
                        <fieldset class="grouped-radiobuttons">
                            ...
                            <div class="row">
                                <input type="radio" id="alwaiver-radio" name="hcbsChoice">
    ...
    <fieldset class="fieldset-container-one" id="focSection">
        <legend class="legend-header-one">Freedom of Choice</legend>
        <fieldset class="fieldset-container-two">
            <legend class="legend-header-two">Provider</legend>
            <div id="readFoc">
                <div class="row">
                    <label for="ProvidersPresentedRead" class="submit-required">List of Providers Presented?</label>
                    <input type="text" id="ProvidersPresentedRead" value="Yes" readonly="readonly"/>
                </div>
                <div class="row">
                    <label for="nurse-nflocdecision" class="submit-required">Provider Chosen:</label>
                    <input type="text" id="nurse-nflocdecision" value="A+ Provider" readonly="readonly"/>
            ...
            <div id="editFoc">
                <div class="row">
                    <label for="ProvidersPresentedRead" class="submit-required">List of Providers Presented?</label>
                    <select id="ProvidersPresentedEdit">
                        <option value="0"></option>
                ...
                <div class="row">
                    ...
                    <select id="nurse-nflocdecision">
                        <option value="0"></option>
                        <option value="1">A+ Provider</option>
                    </select>
                </div>
            </div>
        </fieldset>
    ...
    <fieldset class="fieldset-container-one">
        ...
        <div class="row">
            ...
            <input type="text" id="personsSignature" value="Signed, paper copy on file." required="required" class="required"/>
        </div>
...
@Html.LabelFor(m => m.InformedChoice.PersonSignature.OtherStatus, "Explain:", new { @class="submit-required" })
        ...
        <div class="row"  id="RepresentativeInformation">
            ...
            <input type="text" id="personSignatureDate" class="date required" value="01/20/2015" required="required"/>
        </div>
...
@Html.LabelFor(m => m.InformedChoice.PersonSignature.StatusDate, "Signature Date:", new { @class="submit-required" })
        ...
        <div class="row">
            ...
            <input type="text" id="witnessSignature" value="Signed, paper copy on file." required="required" class="required"/>
        </div>
...
@Html.LabelFor(m => m.InformedChoice.WitnessSignature.OtherStatus, "Explain:", new { @class="submit-required" })
        ...
        <div class="row" id="">
            ...
            <input type="text" id="witnessSignatureDate" class="date required" value="01/20/2015" required="required"/>
        </div>
    </fieldset>
    <fieldset class="fieldset-container-one">
...
@Html.LabelFor(m => m.InformedChoice.PersonSignature.StatusDate, "Signature Date:", new { @class="submit-required" })
        ...
        <div class="row">
            ...
            <input type="text" id="witnessSignature" value="Sample Credentials" required="required" class="required"/>
        </div>
        <div class="row" style="display: none" id="WitnessSignatureInformation">
            <fieldset class="fieldset-container-three">
                <legend class="ui-hide">Explain:</legend>
...
<?php $Script='
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var hcbsRadioGroup = $(\'[name="choiceRadio"]\'),
                hcbsRadio = "#homeCommunityBasedRadio",
                isRadio = "#institionalSettingRadio",
                hcbsSection = "#hcbsSection",
                focSectionEdit = "#editFoc",
                focSectionRead = "#readFoc",
                focSection = "#focSection",
                hcbsSectionVisibility = function() {
                    if ($(hcbsRadio).attr("checked") == "checked") {
                        $(hcbsSection).show();
                    } else {
                        $(hcbsSection).hide();
                    }
                },
                focSectionVisibility = function() {
                     if ($(hcbsRadio).attr("checked") == "checked") {
                        $(focSection).show();
                        $(focSectionEdit).hide();
                        $(focSectionRead).show();
                    } else if ($(isRadio).attr("checked") == "checked") {
                        $(focSection).show();
                        $(focSectionEdit).show();
                        $(focSectionRead).hide();
                    } else if ($(hcbsRadio).attr("checked") != "checked" && $(isRadio).attr("checked") != "checked" ) {
                        $(focSection).hide();
                    }
                };

            //HBCS Section Visibility
            hcbsSectionVisibility();
            focSectionVisibility();
            hcbsRadioGroup.on("click", function(){
                hcbsSectionVisibility();
                focSectionVisibility();
            });
