...
ob_start();
include  "application/views/areas/activitysupportplan/shared/_SummaryContent.php";
$ASPSummaryContent = ob_get_clean();
...
$WorkspaceHeader = '
<h3>Individual Plan - Summary <span>Status: Approved</span></h3>
<div class="workspace-header-bar">

    <div class="float-left">
        <button type="button" onclick="window.location.href= \''.base_url('/index.php/pss/history').'\'">Back to List</button>
    </div>
...
Ace Mannger
                                            ...
                                            <td data-bind="yesNo: Psychotropic">
                                                <a href="'.base_url()."index.php/pss/medicationchangerequestreview".'">View</a>
                                            </td>
                                        </tr>
                                        <tr id="editItemRow">
                                            <td data-bind="text: Medication">
                                            ...
                                            <td data-bind="yesNo: Psychotropic">
                                                <a href="'.base_url()."index.php/pss/medicationchangerequestview".'">View</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
';?>
<?php
require "application/views/areas/activitysupportplan/shared/_OutcomesList.php";
?>
...
$Script='
    <script type="text/javascript">
        $(document).ready(function(){
            $("#outcomesList").on("click", function(){
                $( "#outcomesListDialog" ).dialog({
                    modal: true,
                    height: 600,
                    width: 800,
                    resizable: false,
