...
<div>
    <ul class="left-side-nav js-accordion">
        <li>
            <span class="leftNavHeader">Flexible Assignments</span>

            <ul class="leftnav-groupcontainer">
                <li>
                    <?php echo new MenuItem("DDA Assignments Configuration", "assignments", "flexibleassignments/summary", "", true, false, "", $this->uri); ?>
                </li>
<!--                <li>-->
