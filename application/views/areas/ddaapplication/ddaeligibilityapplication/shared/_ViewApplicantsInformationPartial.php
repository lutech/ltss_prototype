...
<fieldset class="fieldset-container-one">
    ...
    <div class="row">
        <fieldset class="grouped-radiobuttons">
            ...
            <div class="row">
                <input id="appliedForMAYes" type="radio" name="appliedForMA"/>
                <label for="appliedForMAYes" class="auto-width">Yes</label>
                <input id="appliedForMANo" type="radio" name="appliedForMA"/>
                <label for="appliedForMANo" class="auto-width">No</label>
            </div>
        </fieldset>
        <div class="fieldset-container-three" id="dateAppliedForMAContainer" style="display:none">
            <div class="row">
                <label class="complete-required" for="dateAppliedForMA">When?</label>
                <input class="date" type="text" id="dateAppliedForMA" name="dateAppliedForMA"/>
            </div>
        </div>
    </div>
    <div class="row">
        <label class="complete-required" for="individualManagedCareOrganization">Individual&apos;s Managed Care Organization:</label>
        <textarea class="comments-textarea" name="individualManagedCareOrganization" id="individualManagedCareOrganization"></textarea>
    </div>
    <div class="row">
        <label class="complete-required" for="individualsPrimaryCarePhysician">Individual&apos;s Primary Care Physician:</label>
        <textarea class="comments-textarea" name="individualsPrimaryCarePhysician" id="individualsPrimaryCarePhysician"></textarea>
    </div>
    <div class="row">
        <label class="complete-required" for="applicationDate">Application Date/Date Received:</label>
        <input class="date" type="text" id="applicationDate" name="applicationDate"/>
    </div>
</fieldset>
' ?>