                ...
                <div class="row">
                    ...
                    <div class="fieldset-container-three" id="otherNeurologicalImpairmentContainer" style="display:none">
                        <div class="row">
                            ...
                            <textarea class="comments-textarea" required="required" id="descrbeOtherNeurologicalImpairments" name="descrbeOtherNeurologicalImpairments"></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<br/>
                ...
                <div class="row">
                    ...
                    <div class="fieldset-container-three" id="otherMeansToGetAroundContainer" style="display:none">
                        <div class="row">
                            ...
                            <textarea class="comments-textarea" required="required" id="explainOtherMeansToGetAround" name="explainOtherMeansToGetAround"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="fieldset-container-three" id="otherAssistanceRequiredContainer" style="display:none">
                        <div class="row">
                            ...
                            <textarea class="comments-textarea" required="required" id="explainOtherAssistanceRequired" name="explainOtherAssistanceRequired"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="fieldset-container-three" id="otherMeansToCommunicateContainer" style="display:none">
                        <div class="row">
                            ...
                            <textarea class="comments-textarea" required="required" id="explainOtherMeansToCommunicate" name="explainOtherMeansToCommunicate"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="fieldset-container-three" id="otherServicesInUseContainer" style="display:none">
                        <div class="row">
                            ...
                            <textarea class="comments-textarea" required="required" id="explainOtherServicesInUse" name="explainOtherServicesInUse"></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <fieldset class="fieldset-container-one">
            ...
            <div class="row">
                ...
                <input type="text" value="" name="emergency" id="emergency"/>
            </div>
        </fieldset>
                 ...
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="dssContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="dssStatus" id="dssStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="boardOfEducationContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="boardOfEducationStatus" id="boardOfEducationStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="localHealthDeptContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="localHealthDeptStatus" id="localHealthDeptStatus">
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="officeOnAgingContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="officeOnAgingStatus" id="officeOnAgingStatus"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="fieldset-container-three" id="otherAgencyServicesContainer" style="display:none">
                        <div class="row">
                            ...
                            <textarea class="comments-textarea" required="required" id="listOtherAgencyServices" name="listOtherAgencyServices"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="dorsContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="dorsStatus" id="dorsStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="mentalHealthServicesContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" class="submit-required" name="mentalHealthServicesStatus" id="mentalHealthServicesStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="nursingHomeServicesContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="nursingHomeServicesStatus" id="nursingHomeServicesStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="assistedLivingServicesContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="assistedLivingServicesStatus" id="assistedLivingServicesStatus"/>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="medicaidServiceContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="medicaidServiceStatus" id="medicaidServiceStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="lahWaiverContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="lahWaiverStatus" id="lahWaiverStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="mdcWaiverContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="mdcWaiverStatus" id="mdcWaiverStatus"/>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="woaWaiverContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="woaWaiverStatus" id="woaWaiverStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="mfcWaiverContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="mfcWaiverStatus" id="mfcWaiverStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="remProgramContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="remProgramStatus" id="remProgramStatus"/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    ...
                    <div class="fieldset-container-three" id="tbiWaiverContainer" style="display:none">
                        <div class="row">
                            ...
                            <input type="text" value="" name="tbiWaiverStatus" id="tbiWaiverStatus"/>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <fieldset class="fieldset-container-two">
        ...
        <div class="column-left">
             <div class="row">
                <input id="otherProgramsOrSerivcesYes" value="otherProgramsOrSerivcesYes" type="radio" name="otherProgramsOrSerivces"/>
                <label for="otherProgramsOrSerivcesYes" class="auto-width">Yes</label>
                <input id="otherProgramsOrSerivcesNo" value="otherProgramsOrSerivcesNo" type="radio" name="otherProgramsOrSerivces"/>
