<div id="requestClarificationDdaApplicationPacketDialog" style="display: none;">
    <form id="requestClarificationDdaApplicationPacketForm" method="post" name="form" action="<?php echo base_url().'index.php/applicationpacket/requestclarification'?>">
        <fieldset class="fieldset-container-one">
            <legend class="legend-header-one">Specify forms which require clarification</legend>
            <div class="row">
        ...
        <fieldset class="fieldset-container-one">
            <legend class="legend-header-one">Specify attachment which require clarification</legend>
                <div class="row">
        ...
        <fieldset class="fieldset-container-one">
            <legend class="legend-header-one">Addtional Clarification Request Comments</legend>
            <div class="row">
