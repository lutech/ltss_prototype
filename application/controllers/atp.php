...
class Atp extends CI_Controller {

    public function index( $area = 'atp', $page = 'history') {
    ...
    public function history( $area = 'atp', $page = 'history', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function details( $area = 'atp', $page = 'details', $layout= '_ClientLayoutView', $topnavtab = 'client') {
