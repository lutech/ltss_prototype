...
class Assessments extends CI_Controller {
    ...
    public function index( $area = 'assessments', $page = 'history') {
    ...
    public function history( $area = 'assessments', $page = 'history', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function details( $area = 'assessments', $page = 'details', $layout= '_ClientLayoutView', $topnavtab = 'client') {
