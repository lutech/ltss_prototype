<?php
	...
	public function index( $area = 'pr', $page = 'history') {
	...
	public function history( $area = 'pr', $page = 'history', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function summary( $area = 'pr', $page = 'summary', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function familyInfo( $area = 'pr', $page = 'familyInfo', $layout= '_ClientLayoutView', $topnavtab = 'client') {
