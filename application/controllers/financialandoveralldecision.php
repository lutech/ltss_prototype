...
class FinancialAndOverallDecision extends CI_Controller {

    public function index( $area = 'financialandoveralldecision', $page = 'history') {
    ...
    public function history( $area = 'financialandoveralldecision', $page = 'history', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function details( $area = 'financialandoveralldecision', $page = 'details', $layout= '_ClientLayoutView', $topnavtab = 'client') {
