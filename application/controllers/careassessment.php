...
class Careassessment extends CI_Controller {
    ...
    public function section_a( $area = 'careassessment', $page = 'section_a', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function section_b( $area = 'careassessment', $page = 'section_b', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function section_c( $area = 'careassessment', $page = 'section_c', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function section_d( $area = 'careassessment', $page = 'section_d', $layout= '_ClientLayoutView', $topnavtab = 'client') {
