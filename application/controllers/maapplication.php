...
class MaApplication extends CI_Controller {

    public function index( $area = 'maapplication', $page = 'history') {
    ...
    public function history( $area = 'maapplication', $page = 'history', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function details( $area = 'maapplication', $page = 'details', $layout= '_ClientLayoutView', $topnavtab = 'client') {
