...
class Activitysupportplan extends CI_Controller {

    public function index( $area = 'pss', $page = 'history') {
    ...
    public function history( $area = 'activitysupportplan', $page = 'history', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function details( $area = 'activitysupportplan', $page = 'details', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function summary( $area = 'activitysupportplan', $page = 'summary', $layout= '_ClientLayoutView', $topnavtab = 'client') {
