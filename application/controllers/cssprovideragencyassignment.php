...
class CssProviderAgencyAssignment extends CI_Controller {

    public function index( $area = 'cssprovideragencyassignment', $page = 'history') {
    ...
    public function history( $area = 'cssprovideragencyassignment', $page = 'history', $layout= '_ClientLayoutView', $topnavtab = 'client') {
    ...
    public function details( $area = 'cssprovideragencyassignment', $page = 'details', $layout= '_ClientLayoutView', $topnavtab = 'client') {
